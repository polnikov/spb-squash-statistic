  ...
  },
  {
    ...
    metrics: [
      ...
      },
      {
        name: "Медиана лиги",
        desc:
          "Рядом с частью метрик показан типичный уровень лиги в том же контексте: засечка на полосе либо дельта к медиане под ней. Это точка отсчёта, а не оценка игрока.",
        scale: [
          { text: "медиана, а не среднее: один доминирующий игрок её не сдвигает" },
          { text: "в выборку входят только игроки, прошедшие ценз по этой метрике" },
          { text: "цензы за сезон: 8 матчей, 24 гейма, 300 розыгрышей, 4 решающих матча, 6 плотных геймов, 4 овертайма, 20 розыгрышей в решающих, 3 матча со счётом 0:2 или 2:0" },
          { text: "за карьеру цензы выше: 25 матчей, 75 геймов, 900 розыгрышей, 10 решающих матчей, 15 плотных геймов, 10 овертаймов, 50 розыгрышей в решающих, 8 матчей со счётом 0:2 или 2:0" },
          { text: "меньше 5 игроков прошло ценз - берётся более широкая база: дивизион → сезон → вся лига" },
          { text: "подпись всегда называет фактическую базу, поэтому «медиана лиги» на дивизионном табе - это норма, а не ошибка" },
          { text: "свой ценз ниже порога - сравнения тоже нет: шум сравнивать не с чем" },
        ],
        example: {
          value: "Rally WR = 54.8%, медиана сезона 50.0",
          read: "+4.8 п.п. к типичному уровню сезона. Карьерная медиана считается по всем дивизионам сразу, поэтому у игроков, поднимавшихся по дивизионам, карьерные значения ниже при том же уровне игры: соперники были сильнее.",
        },
      },
    ],
