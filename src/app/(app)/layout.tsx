  ...
  return (
    <div className="app-bg flex min-h-dvh">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        <header className="sticky top-0 z-40 flex items-center justify-between gap-3 border-b border-border bg-[rgba(22,22,22,0.94)] px-2 py-2.5 shadow-[0_4px_18px_rgba(0,0,0,0.5)] backdrop-blur-[6px] md:hidden">
